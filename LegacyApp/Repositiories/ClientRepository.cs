...
namespace LegacyApp.Repositiories
{
    public class ClientRepository : IClientRepository
    {
        ...
        public static readonly Dictionary<int, Client> Database = new Dictionary<int, Client>()
        {
            ...
            {2, new Client{ClientId = 2, Name = "Malewski", Address = "Warszawa, Koszykowa 86", Email = "malewski@gmail.pl", Type = ClientType.VeryImportant}},
